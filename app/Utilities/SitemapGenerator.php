...
class SitemapGenerator
{
    ...
    protected function generateQuestionsSitemap($this_time)
    {
        ...
        //for ($i = 1; $i <= $iterations; $i++) {
            ...
            $sitemap->writeToFile(public_path("sitemap-questions-161.xml"));
    ...
    protected function questionUrls()
    {
        ...
        ->where('questions.question', '=','Top places to buy fruit and veggies') // Adjust the condition for starting ID
        ->get();
